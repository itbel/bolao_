...
export declare class Tournament {
  ...
  readonly rounds?: (Round | null)[] | null;
  readonly createdAt?: string | null;
  readonly updatedAt?: string | null;
...
export declare class Round {
  ...
  readonly createdAt?: string | null;
  readonly updatedAt?: string | null;
  constructor(init: ModelInit<Round, RoundMetaData>);
  static copyOf(
    source: Round,
    mutator: (
      draft: MutableModel<Round, RoundMetaData>
    ) => MutableModel<Round, RoundMetaData> | void
  ): Round;
}
