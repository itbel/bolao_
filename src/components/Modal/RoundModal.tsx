...
import { CreateRoundMutation, Round } from "../../API";
...
export default function RoundModal({
  ...
  const createRound = async (name: string) => {
    ...
    try {
      ...
      })) as GraphQLResult<CreateRoundMutation>;
      if (response.data?.createRound) console.log("Success");
    } catch (error) {
      console.log(error);
    } finally {
      setIsLoading(false);
      ...
      <View style={styles.container}>
        <View style={styles.modalContainer}>
          ...
          <SimpleTextInput
            ...
            onChangeText={(value) => setRoundName(value)}
            value={roundName}
            returnKeyType="done"
